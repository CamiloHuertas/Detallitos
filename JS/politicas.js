...
ScrollReveal().reveal('.politics', {
  delay: "500",
  origin: "left",
  distance: "500px"
})
ScrollReveal().reveal('.confidential .subtitle', {
  delay: "500",
  origin: "left",
  distance: "500px"
})
ScrollReveal().reveal('.confidential .text', {
  delay: "500",
  origin: "left",
  distance: "500px"
})
ScrollReveal().reveal('.delivery .subtitle', {
  delay: "500",
  origin: "left",
  distance: "500px"
})
ScrollReveal().reveal('.delivery .text', {
  delay: "500",
  origin: "left",
  distance: "500px"
})
ScrollReveal().reveal('.dueTime', {
  delay: "500",
  origin: "left",
  distance: "500px"
})
ScrollReveal().reveal('.ways', {
  delay: "500",
  origin: "left",
  distance: "500px"
})
ScrollReveal().reveal('.important', {
  delay: "500",
  origin: "left",
  distance: "500px"
})
